...
from photocatalysis.evaluate import calculate_thermochemistry, global_min_configurations, multi_calculate_thermochemistry
...
if __name__ == '__main__':
    ...
    for b_num, b in enumerate(batches):
        ...
        #     print('Error/Timeout Encountered')
        #     print(e)
        #     os.system('echo "{}" >> errors_test.txt'.format(e))
        #     # os.chdir(path_system_to_calculate_results)
        break
